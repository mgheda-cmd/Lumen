/**
 * SERVICE DE SIGNATURE MEXC FUTURES V1 & SPOT V3 INDÉPENDANT SÉCURISÉ
 * Compatible Vercel, Netlify, Cloudflare Workers et Node.js Express.
 */

const crypto = require('crypto');

// En mémoire pour anti-doublon, cache contractSize & logs
